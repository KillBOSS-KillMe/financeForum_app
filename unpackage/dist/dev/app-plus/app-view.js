...
var hWT=_mz(z,'input',['bindinput',6,'data-event-opts',1,'data-name',2,'placeholder',3,'type',4,'value',5],[],e,s,gg)
_(cVT,hWT)
var oXT=_mz(z,'uni-icon',['type',-1,'bind:__l',12,'class',1,'vueId',2],[],e,s,gg)
_(cVT,oXT)
_(xST,cVT)
_(oRT,xST)
var cYT=_n('view')
...
var t3T=_mz(z,'input',['bindinput',18,'data-event-opts',1,'data-name',2,'placeholder',3,'type',4,'value',5],[],e,s,gg)
_(a2T,t3T)
var e4T=_mz(z,'uni-icon',['type',-1,'bind:__l',24,'class',1,'vueId',2],[],e,s,gg)
_(a2T,e4T)
_(cYT,a2T)
_(oRT,cYT)
var b5T=_n('view')
_rz(z,b5T,'class',27,e,s,gg)
var o6T=_n('text')
...
var f9T=_mz(z,'input',['bindinput',30,'data-event-opts',1,'data-name',2,'placeholder',3,'type',4,'value',5],[],e,s,gg)
_(o8T,f9T)
var c0T=_mz(z,'uni-icon',['type',-1,'bind:__l',36,'class',1,'vueId',2],[],e,s,gg)
_(o8T,c0T)
_(b5T,o8T)
_(oRT,b5T)
_(ePT,oRT)
...
var aFU=_mz(z,'view',['bindtap',43,'data-event-opts',1],[],e,s,gg)
var tGU=_v()
_(aFU,tGU)
if(_oz(z,45,e,s,gg)){tGU.wxVkey=1
var eHU=_mz(z,'image',['mode',-1,'src',46],[],e,s,gg)
_(tGU,eHU)
}
else{tGU.wxVkey=2
var bIU=_mz(z,'image',['mode',-1,'src',47],[],e,s,gg)
_(tGU,bIU)
}
tGU.wxXCkey=1
_(lEU,aFU)
var oJU=_mz(z,'view',['bindtap',48,'data-event-opts',1],[],e,s,gg)
var xKU=_v()
_(oJU,xKU)
if(_oz(z,50,e,s,gg)){xKU.wxVkey=1
var oLU=_mz(z,'image',['mode',-1,'src',51],[],e,s,gg)
_(xKU,oLU)
}
else{xKU.wxVkey=2
var fMU=_mz(z,'image',['mode',-1,'src',52],[],e,s,gg)
_(xKU,fMU)
}
xKU.wxXCkey=1
_(lEU,oJU)
_(oBU,lEU)
_(ePT,oBU)
var cNU=_mz(z,'button',['bindtap',53,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
var hOU=_oz(z,57,e,s,gg)
_(cNU,hOU)
_(ePT,cNU)
_(r,ePT)
return r
