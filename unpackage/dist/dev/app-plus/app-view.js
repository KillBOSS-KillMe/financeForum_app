...
var cNG=_n('text')
_rz(z,cNG,'class',82,aFG,lEG,gg)
var hOG=_oz(z,83,aFG,lEG,gg)
_(cNG,hOG)
_(fMG,cNG)
var oPG=_mz(z,'uni-icon',['type',-1,'bind:__l',84,'class',1,'vueId',2],[],aFG,lEG,gg)
_(fMG,oPG)
var cQG=_n('text')
_rz(z,cQG,'class',87,aFG,lEG,gg)
var oRG=_oz(z,88,aFG,lEG,gg)
_(cQG,oRG)
_(fMG,cQG)
_(oLG,fMG)
var lSG=_mz(z,'uni-icon',['type',-1,'bind:__l',89,'class',1,'vueId',2],[],aFG,lEG,gg)
_(oLG,lSG)
_(xKG,oLG)
var aTG=_n('text')
_rz(z,aTG,'class',92,aFG,lEG,gg)
...
var h3G=_n('view')
_rz(z,h3G,'class',98,oZG,xYG,gg)
var o4G=_n('text')
_rz(z,o4G,'class',99,oZG,xYG,gg)
var c5G=_oz(z,100,oZG,xYG,gg)
_(o4G,c5G)
_(h3G,o4G)
var o6G=_n('text')
var l7G=_oz(z,101,oZG,xYG,gg)
_(o6G,l7G)
_(h3G,o6G)
var a8G=_n('text')
_rz(z,a8G,'class',102,oZG,xYG,gg)
var t9G=_oz(z,103,oZG,xYG,gg)
_(a8G,t9G)
_(h3G,a8G)
var e0G=_n('view')
var bAH=_oz(z,104,oZG,xYG,gg)
_(e0G,bAH)
_(h3G,e0G)
_(f1G,h3G)
return f1G
...
bWG.wxXCkey=2
_2z(z,96,oXG,aFG,lEG,gg,bWG,'postComItem','postComIndex','postComIndex')
_(xKG,eVG)
var oBH=_n('view')
_rz(z,oBH,'class',105,aFG,lEG,gg)
var xCH=_n('view')
_rz(z,xCH,'class',106,aFG,lEG,gg)
var oDH=_n('text')
var fEH=_oz(z,107,aFG,lEG,gg)
_(oDH,fEH)
_(xCH,oDH)
var cFH=_n('text')
var hGH=_oz(z,108,aFG,lEG,gg)
_(cFH,hGH)
_(xCH,cFH)
_(oBH,xCH)
var oHH=_mz(z,'uni-icon',['type',-1,'bind:__l',109,'bind:tap',1,'class',2,'data-event-opts',3,'data-id',4,'data-num',5,'vueId',6],[],aFG,lEG,gg)
_(oBH,oHH)
_(xKG,oBH)
_(bIG,xKG)
_(tGG,bIG)
...
_(eJE,o6F)
var cIH=_n('view')
_rz(z,cIH,'class',116,e,s,gg)
var lKH=_mz(z,'input',['bindinput',117,'data-event-opts',1,'focus',2,'placeholder',3,'type',4,'value',5],[],e,s,gg)
_(cIH,lKH)
var aLH=_mz(z,'uni-icon',['type',-1,'bind:__l',123,'bind:tap',1,'class',2,'data-event-opts',3,'vueId',4],[],e,s,gg)
_(cIH,aLH)
var oJH=_v()
_(cIH,oJH)
if(_oz(z,128,e,s,gg)){oJH.wxVkey=1
var tMH=_mz(z,'uni-icon',['type',-1,'bind:__l',129,'bind:tap',1,'class',2,'data-event-opts',3,'vueId',4],[],e,s,gg)
_(oJH,tMH)
}
else{oJH.wxVkey=2
var eNH=_mz(z,'uni-icon',['type',-1,'bind:__l',134,'class',1,'vueId',2],[],e,s,gg)
_(oJH,eNH)
}
oJH.wxXCkey=1
_(eJE,cIH)
...
var aFN=_mz(z,'view',['bindtap',27,'class',1,'data-bind_board',2,'data-event-opts',3,'data-link',4,'data-name',5],[],cCN,oBN,gg)
var tGN=_mz(z,'image',['mode',33,'src',1],[],cCN,oBN,gg)
_(aFN,tGN)
var eHN=_n('text')
var bIN=_oz(z,35,cCN,oBN,gg)
_(eHN,bIN)
_(aFN,eHN)
_(oDN,aFN)
return oDN
...
var oRN=_mz(z,'view',['bindtap',42,'class',1,'data-block_id',2,'data-event-opts',3,'data-index',4],[],hON,cNN,gg)
var lSN=_oz(z,47,hON,cNN,gg)
_(oRN,lSN)
_(oPN,oRN)
return oPN
}
oLN.wxXCkey=2
_2z(z,40,fMN,e,s,gg,oLN,'item','index','index')
_(oJN,xKN)
var aTN=_n('view')
...
var f1N=_mz(z,'view',['bindtap',53,'class',1,'data-event-opts',2,'data-id',3],[],oXN,bWN,gg)
var c2N=_v()
_(f1N,c2N)
if(_oz(z,57,oXN,bWN,gg)){c2N.wxVkey=1
var h3N=_mz(z,'image',['mode',58,'src',1],[],oXN,bWN,gg)
_(c2N,h3N)
}
else{c2N.wxVkey=2
var o4N=_mz(z,'image',['mode',60,'src',1],[],oXN,bWN,gg)
_(c2N,o4N)
}
var c5N=_n('view')
_rz(z,c5N,'class',62,oXN,bWN,gg)
var o6N=_n('text')
_rz(z,o6N,'class',63,oXN,bWN,gg)
var l7N=_oz(z,64,oXN,bWN,gg)
_(o6N,l7N)
_(c5N,o6N)
var a8N=_n('view')
_rz(z,a8N,'class',65,oXN,bWN,gg)
var t9N=_n('text')
var e0N=_oz(z,66,oXN,bWN,gg)
_(t9N,e0N)
_(a8N,t9N)
var bAO=_n('text')
var oBO=_oz(z,67,oXN,bWN,gg)
_(bAO,oBO)
_(a8N,bAO)
var xCO=_n('text')
var oDO=_oz(z,68,oXN,bWN,gg)
_(xCO,oDO)
_(a8N,xCO)
_(c5N,a8N)
_(f1N,c5N)
...
tUN.wxXCkey=2
_2z(z,51,eVN,e,s,gg,tUN,'item','index','index')
_(oJN,aTN)
_(hWM,oJN)
_(r,hWM)
return r
...
var lEFB=_mz(z,'button',['disabled',-1,'type',-1,'class',69],[],e,s,gg)
var aFFB=_oz(z,70,e,s,gg)
_(lEFB,aFFB)
_(oFDB,lEFB)
}
else{oFDB.wxVkey=2
var tGFB=_mz(z,'button',['type',-1,'bindtap',71,'class',1,'data-event-opts',2,'data-id',3,'data-money',4,'style',5],[],e,s,gg)
var eHFB=_oz(z,77,e,s,gg)
_(tGFB,eHFB)
_(oFDB,tGFB)
}
var bIFB=_n('view')
_rz(z,bIFB,'class',78,e,s,gg)
var oJFB=_n('label')
var xKFB=_mz(z,'checkbox',['bindtap',79,'checked',1,'data-event-opts',2,'style',3,'value',4],[],e,s,gg)
_(oJFB,xKFB)
_(bIFB,oJFB)
var oLFB=_n('view')
var fMFB=_oz(z,84,e,s,gg)
_(oLFB,fMFB)
var cNFB=_mz(z,'text',['bindtap',85,'data-event-opts',1],[],e,s,gg)
