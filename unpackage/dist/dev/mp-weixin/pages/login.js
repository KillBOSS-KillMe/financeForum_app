...
//
//
var app = getApp();var _default = { data: function data() {return { loginPaw: '', loginName: '' };}, onShow: function onShow() {uni.hideHomeButton();}, onLoad: function onLoad() {console.log(_helper.default.requestUrl);}, methods: { // 获取登录名
