...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/me"],{"1b5a":function(e,t,a){"use strict";var n,o=function(){var e=this,t=e.$createElement;e._self._c},u=[];a.d(t,"b",function(){return o}),a.d(t,"c",function(){return u}),a.d(t,"a",function(){return n})},"50eb":function(e,t,a){"use strict";a.r(t);var n=a("f3b0"),o=a.n(n);for(var u in n)"default"!==u&&function(e){a.d(t,e,function(){return n[e]})}(u);t["default"]=o.a},"6ca6":function(e,t,a){},ce7d:function(e,t,a){"use strict";var n=a("6ca6"),o=a.n(n);o.a},f3b0:function(e,t,a){"use strict";(function(e,n){Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var o=u(a("a3a0"));function u(e){return e&&e.__esModule?e:{default:e}}var r=getApp(),i={data:function(){return{userInfo:{},imgUrl:"",imageUrl:""}},onLoad:function(){this.imgUrl=o.default.imgUrl},onShow:function(){this.getUserInfo()},methods:{goPageNavigateTo:function(t){console.log(e(t," at pages\\me.vue:112"));var a=t.currentTarget.dataset.name;"meNewbieRead"==a?n.navigateTo({url:"/pages/articleDetail?id=".concat(21)}):"meReserve"==a?n.navigateTo({url:"/pages/indexAccurate?id=".concat(9,"&name=","备用金打造")}):"meAllProduct"==a?n.navigateTo({url:"/pages/indexAccurate?id=".concat(11,"&name=","各省产品汇总")}):"meSpread"==a?(console.log(e(a," at pages\\me.vue:128")),console.log(e(this.userInfo.type," at pages\\me.vue:129")),"normal"==this.userInfo.type?(n.showToast({title:"您不是会员，暂无此权限",icon:"none",duration:1e3}),setTimeout(function(e){n.navigateTo({url:"/pages/meVIP"})},1600)):n.navigateTo({url:"/pages/meSpread"})):n.navigateTo({url:"/pages/".concat(a)})},getUserInfo:function(){var e=this;n.showLoading({title:"用户信息获取中..."}),n.request({url:"".concat(o.default.requestUrl,"/me"),method:"POST",header:{authorization:r.globalData.token},success:function(t){n.hideLoading(),t=o.default.null2str(t),200==t.statusCode&&(e.userInfo=t.data,e.imageUrl=e.imgUrl+e.userInfo.avatar)}})}}};t.default=i}).call(this,a("0de9")["default"],a("6e42")["default"])},f405:function(e,t,a){"use strict";a.r(t);var n=a("1b5a"),o=a("50eb");for(var u in o)"default"!==u&&function(e){a.d(t,e,function(){return o[e]})}(u);a("ce7d");var r,i=a("f0c5"),c=Object(i["a"])(o["default"],n["b"],n["c"],!1,null,null,null,!1,n["a"],r);t["default"]=c.exports},f4f5:function(e,t,a){"use strict";(function(e){a("b5b4"),a("921b");n(a("66fd"));var t=n(a("f405"));function n(e){return e&&e.__esModule?e:{default:e}}e(t.default)}).call(this,a("6e42")["createPage"])}},[["f4f5","common/runtime","common/vendor"]]]);
});
require('pages/me.js');
