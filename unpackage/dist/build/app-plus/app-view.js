...
var cFH=_mz(z,'input',['bindinput',111,'data-event-opts',1,'focus',2,'placeholder',3,'type',4,'value',5],[],e,s,gg)
_(fEH,cFH)
var hGH=_mz(z,'uni-icon',['type',-1,'bind:__l',117,'bind:tap',1,'class',2,'data-event-opts',3,'vueId',4],[],e,s,gg)
_(fEH,hGH)
var oHH=_mz(z,'uni-icon',['type',-1,'bind:__l',122,'bind:tap',1,'class',2,'data-event-opts',3,'vueId',4],[],e,s,gg)
_(fEH,oHH)
_(eJE,fEH)
_(r,eJE)
return r
...
var aD4=_mz(z,'view',['bindtap',18,'class',1,'data-event-opts',2,'data-id',3],[],lY3,oX3,gg)
var tE4=_n('view')
_rz(z,tE4,'class',22,lY3,oX3,gg)
var eF4=_n('view')
_rz(z,eF4,'class',23,lY3,oX3,gg)
var bG4=_n('label')
_rz(z,bG4,'class',24,lY3,oX3,gg)
var oH4=_oz(z,25,lY3,oX3,gg)
_(bG4,oH4)
_(eF4,bG4)
var xI4=_n('label')
_rz(z,xI4,'class',26,lY3,oX3,gg)
var oJ4=_oz(z,27,lY3,oX3,gg)
_(xI4,oJ4)
_(eF4,xI4)
_(tE4,eF4)
var fK4=_n('view')
_rz(z,fK4,'class',28,lY3,oX3,gg)
var cL4=_n('label')
_rz(z,cL4,'class',29,lY3,oX3,gg)
var hM4=_oz(z,30,lY3,oX3,gg)
_(cL4,hM4)
_(fK4,cL4)
_(tE4,fK4)
_(aD4,tE4)
...
var fYOB=_v()
_(oXOB,fYOB)
if(_oz(z,7,e,s,gg)){fYOB.wxVkey=1
var h1OB=_n('view')
...
var cZOB=_v()
_(oXOB,cZOB)
if(_oz(z,10,e,s,gg)){cZOB.wxVkey=1
var c3OB=_n('view')
...
cZOB.wxXCkey=1
_(xWOB,oXOB)
var l5OB=_mz(z,'input',['bindinput',13,'data-event-opts',1,'placeholder',2,'value',3],[],e,s,gg)
_(xWOB,l5OB)
var a6OB=_mz(z,'text',['bindtap',17,'data-event-opts',1],[],e,s,gg)
var t7OB=_oz(z,19,e,s,gg)
_(a6OB,t7OB)
_(xWOB,a6OB)
_(eTOB,xWOB)
var bUOB=_v()
_(eTOB,bUOB)
if(_oz(z,20,e,s,gg)){bUOB.wxVkey=1
var e8OB=_n('view')
_rz(z,e8OB,'class',21,e,s,gg)
var b9OB=_v()
_(e8OB,b9OB)
var o0OB=function(oBPB,xAPB,fCPB,gg){
var hEPB=_mz(z,'view',['bindtap',26,'class',1,'data-event-opts',2,'data-id',3],[],oBPB,xAPB,gg)
var oFPB=_v()
_(hEPB,oFPB)
if(_oz(z,30,oBPB,xAPB,gg)){oFPB.wxVkey=1
var cGPB=_mz(z,'image',['mode',31,'src',1],[],oBPB,xAPB,gg)
_(oFPB,cGPB)
}
else{oFPB.wxVkey=2
var oHPB=_mz(z,'image',['mode',33,'src',1],[],oBPB,xAPB,gg)
_(oFPB,oHPB)
}
var lIPB=_n('view')
_rz(z,lIPB,'class',35,oBPB,xAPB,gg)
var aJPB=_n('text')
_rz(z,aJPB,'class',36,oBPB,xAPB,gg)
var tKPB=_oz(z,37,oBPB,xAPB,gg)
_(aJPB,tKPB)
_(lIPB,aJPB)
var eLPB=_n('view')
_rz(z,eLPB,'class',38,oBPB,xAPB,gg)
var bMPB=_n('text')
var oNPB=_oz(z,39,oBPB,xAPB,gg)
_(bMPB,oNPB)
_(eLPB,bMPB)
var xOPB=_n('text')
var oPPB=_oz(z,40,oBPB,xAPB,gg)
_(xOPB,oPPB)
_(eLPB,xOPB)
var fQPB=_n('text')
var cRPB=_oz(z,41,oBPB,xAPB,gg)
_(fQPB,cRPB)
_(eLPB,fQPB)
_(lIPB,eLPB)
_(hEPB,lIPB)
...
b9OB.wxXCkey=2
_2z(z,24,o0OB,e,s,gg,b9OB,'item','index','index')
_(bUOB,e8OB)
}
var oVOB=_v()
_(eTOB,oVOB)
if(_oz(z,42,e,s,gg)){oVOB.wxVkey=1
var hSPB=_n('view')
...
var eZPB=_n('view')
_rz(z,eZPB,'class',48,lWPB,oVPB,gg)
var b1PB=_v()
_(eZPB,b1PB)
if(_oz(z,49,lWPB,oVPB,gg)){b1PB.wxVkey=1
var o2PB=_n('image')
_rz(z,o2PB,'src',50,lWPB,oVPB,gg)
_(b1PB,o2PB)
}
else{b1PB.wxVkey=2
var x3PB=_n('image')
_rz(z,x3PB,'src',51,lWPB,oVPB,gg)
_(b1PB,x3PB)
}
var o4PB=_n('view')
_rz(z,o4PB,'class',52,lWPB,oVPB,gg)
var f5PB=_n('view')
var o8PB=_n('text')
_rz(z,o8PB,'class',53,lWPB,oVPB,gg)
var c9PB=_oz(z,54,lWPB,oVPB,gg)
_(o8PB,c9PB)
_(f5PB,o8PB)
var c6PB=_v()
_(f5PB,c6PB)
if(_oz(z,55,lWPB,oVPB,gg)){c6PB.wxVkey=1
var o0PB=_mz(z,'uni-icon',['type',-1,'bind:__l',56,'class',1,'vueId',2],[],lWPB,oVPB,gg)
_(c6PB,o0PB)
}
var h7PB=_v()
_(f5PB,h7PB)
if(_oz(z,59,lWPB,oVPB,gg)){h7PB.wxVkey=1
var lAQB=_mz(z,'uni-icon',['type',-1,'bind:__l',60,'class',1,'vueId',2],[],lWPB,oVPB,gg)
_(h7PB,lAQB)
}
var aBQB=_n('text')
_rz(z,aBQB,'class',63,lWPB,oVPB,gg)
var tCQB=_oz(z,64,lWPB,oVPB,gg)
_(aBQB,tCQB)
_(f5PB,aBQB)
c6PB.wxXCkey=1
h7PB.wxXCkey=1
_(o4PB,f5PB)
var eDQB=_n('view')
_rz(z,eDQB,'class',65,lWPB,oVPB,gg)
var bEQB=_oz(z,66,lWPB,oVPB,gg)
_(eDQB,bEQB)
_(o4PB,eDQB)
_(eZPB,o4PB)
var oFQB=_n('view')
_rz(z,oFQB,'class',67,lWPB,oVPB,gg)
_(eZPB,oFQB)
b1PB.wxXCkey=1
_(aXPB,eZPB)
return aXPB
...
oTPB.wxXCkey=2
_2z(z,46,cUPB,e,s,gg,oTPB,'item','index','index')
_(oVOB,hSPB)
}
bUOB.wxXCkey=1
oVOB.wxXCkey=1
...
var oLQB=_mz(z,'input',['bindinput',2,'data-event-opts',1,'placeholder',2,'value',3],[],e,s,gg)
_(hKQB,oLQB)
var cMQB=_mz(z,'text',['bindtap',6,'data-event-opts',1],[],e,s,gg)
var oNQB=_oz(z,8,e,s,gg)
_(cMQB,oNQB)
_(hKQB,cMQB)
_(oHQB,hKQB)
var fIQB=_v()
_(oHQB,fIQB)
if(_oz(z,9,e,s,gg)){fIQB.wxVkey=1
var lOQB=_n('view')
var aPQB=_v()
_(lOQB,aPQB)
if(_oz(z,10,e,s,gg)){aPQB.wxVkey=1
var eRQB=_n('view')
...
_(eRQB,bSQB)
var xUQB=_n('view')
_rz(z,xUQB,'class',14,e,s,gg)
var oVQB=_v()
_(xUQB,oVQB)
var fWQB=function(hYQB,cXQB,oZQB,gg){
var o2QB=_mz(z,'view',['bindtap',19,'class',1,'data-event-opts',2],[],hYQB,cXQB,gg)
var l3QB=_n('view')
var a4QB=_n('icon')
...
_(l3QB,t5QB)
_(o2QB,l3QB)
var b7QB=_mz(z,'icon',['catchtap',24,'class',1,'data-event-opts',2],[],hYQB,cXQB,gg)
_(o2QB,b7QB)
_(oZQB,o2QB)
return oZQB
}
oVQB.wxXCkey=2
_2z(z,17,fWQB,e,s,gg,oVQB,'item','index','index')
_(eRQB,xUQB)
_(aPQB,eRQB)
}
var tQQB=_v()
_(lOQB,tQQB)
if(_oz(z,27,e,s,gg)){tQQB.wxVkey=1
var o8QB=_mz(z,'view',['bindtap',28,'class',1,'data-event-opts',2],[],e,s,gg)
var x9QB=_oz(z,31,e,s,gg)
_(o8QB,x9QB)
_(tQQB,o8QB)
}
aPQB.wxXCkey=1
...
var cJQB=_v()
_(oHQB,cJQB)
if(_oz(z,32,e,s,gg)){cJQB.wxVkey=1
var o0QB=_n('view')
_rz(z,o0QB,'class',33,e,s,gg)
var fARB=_v()
_(o0QB,fARB)
if(_oz(z,34,e,s,gg)){fARB.wxVkey=1
var hCRB=_n('view')
_rz(z,hCRB,'class',35,e,s,gg)
var oDRB=_v()
_(hCRB,oDRB)
var cERB=function(lGRB,oFRB,aHRB,gg){
var eJRB=_mz(z,'view',['bindtap',40,'class',1,'data-event-opts',2],[],lGRB,oFRB,gg)
var bKRB=_n('image')
_rz(z,bKRB,'src',43,lGRB,oFRB,gg)
_(eJRB,bKRB)
var oLRB=_n('text')
var xMRB=_oz(z,44,lGRB,oFRB,gg)
_(oLRB,xMRB)
_(eJRB,oLRB)
_(aHRB,eJRB)
return aHRB
...
oDRB.wxXCkey=2
_2z(z,38,cERB,e,s,gg,oDRB,'item','index','index')
_(fARB,hCRB)
}
var cBRB=_v()
_(o0QB,cBRB)
if(_oz(z,45,e,s,gg)){cBRB.wxVkey=1
var oNRB=_n('view')
_rz(z,oNRB,'class',46,e,s,gg)
var fORB=_n('text')
var cPRB=_oz(z,47,e,s,gg)
_(fORB,cPRB)
_(oNRB,fORB)
_(cBRB,oNRB)
}
...
_(bCSB,oDSB)
var oFSB=_n('view')
_rz(z,oFSB,'class',16,e,s,gg)
var fGSB=_n('view')
var cHSB=_oz(z,17,e,s,gg)
_(fGSB,cHSB)
var hISB=_n('text')
var oJSB=_oz(z,18,e,s,gg)
_(hISB,oJSB)
_(fGSB,hISB)
var cKSB=_oz(z,19,e,s,gg)
_(fGSB,cKSB)
_(oFSB,fGSB)
var oLSB=_n('view')
