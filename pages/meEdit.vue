<template>
	<view class="edit">
		...
		<view class="itemList">
			<text>签名</text>
			<input type="text" value="嘻嘻嘻嘻嘻嘻嘻嘻寻寻寻寻寻寻寻寻寻寻寻寻寻寻寻寻寻" placeholder=""/>
		</view>
		<view class="itemList">
			<text>真实姓名</text>
			<input type="text" value="黎明" placeholder=""/>
		</view>
		<view class="itemList">
			<text>性别</text>
		...
		<view class="itemList">
			<text>学历</text>
			<input type="text" value="本科" placeholder=""/>
		</view>
		<view class="itemList">
			<text>支付宝</text>
			<input type="text" value="999" placeholder=""/>
		</view>
		<view class="itemList">
			<text>芝麻信用分</text>
			<input type="text" value="999" placeholder=""/>
		...
		<view class="itemList">
			<text>信用卡</text>
			<input type="text" value="无" placeholder=""/>
		</view>
		<view class="itemList">
			<text>社保</text>
			<input type="text" value="无" placeholder=""/>
		...
		<view class="itemList">
			<text>公积金</text>
			<input type="text" value="99" placeholder=""/>
		</view>
		<view class="itemList">
			<text>手机</text>
			<input type="text" value="999" placeholder=""/>
